        ...
        <div className="container px-3 mx-auto 2xl:px-32 xl:grid grid-cols-3 flex-colo py-10 lg:py-20 gap-8">
          ...
          <div className="col-span-2 md:grid grid-cols-5 gap-4 items-center">
            <div className="col-span-3 flex flex-col gap-10">
              ...
              <div className="grid sm:grid-cols-5 grid-cols-3 gap-4 p-6 bg-main border border-gray-800 rounded-lg">
                ...
                <div className="sm:col-span-2 col-span-3 flex justify-end font-medium text-sm">
                  <Link
                    to={`/watch/${movie?.name}`}
                    className=" transitions flex-rows gap-4 w-full sm:py-3"
                  >
                    <button className="hover:shadow-md hover:scale-100">
                      {/* <FaPlay /> Watch */}
                      <Titles title="Watch" Icon={FaPlay} />
                    </button>
                  </Link>
                </div>
              </div>
            ...
            <div className="col-span-2 md:mt-0 mt-2 flex justify-end">
              <button className="md:w-1/4 w-full relative flex-colo bg-subMain hover:bg-transparent transitions md:h-64 h-20 rounded font-medium">
