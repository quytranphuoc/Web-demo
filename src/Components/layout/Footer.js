...
<footer class="bg-dry dark:bg-gray-900 text-center">
      ...
      <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
        <div>
            ...
            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                ...
                <li class="mb-4">
                    <a href="#" class={Hover}>Careers</a>
                </li>
                <li class="mb-4">
                    <a href="#" class={Hover}>Brand Center</a>
                </li>
                <li class="mb-4">
                    <a href="#" class={Hover}>Blog</a>
                </li>
            </ul>
        </div>
        <div>
            ...
            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                <li class="mb-4">
                    <a href="#" class={Hover}>Discord Server</a>
                </li>
                <li class="mb-4">
                ...
                <li class="mb-4">
                    <a href="#" class={Hover}>Contact Us</a>
                </li>
            </ul>
        </div>
        <div>
            ...
            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                ...
                <li class="mb-4">
                    <a href="#" class={Hover}>Licensing</a>
                </li>
                <li class="mb-4">
                    <a href="#" class={Hover}>Terms &amp; Conditions</a>
                </li>
            </ul>
        </div>
        <div>
            ...
            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                <li class="mb-4">
                    <a href="#" class={Hover}>iOS</a>
                </li>
                <li class="mb-4">
                    <a href="#" class={Hover}>Android</a>
                </li>
                <li class="mb-4">
                    <a href="#" class={Hover}>Windows</a>
                </li>
                <li class="mb-4">
                    <a href="#" class={Hover}>MacOS</a>
                </li>
            </ul>
        </div>
    </div>
